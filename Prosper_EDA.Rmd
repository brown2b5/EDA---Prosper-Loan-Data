...
getwd()
setwd("C:/Users/brownb/Desktop/Udacity/Data Analyst Nanodegree/Term 2
      /Exploratory Data Analysis/EDA - Prosper Loan Data")
```
...
the number who successfuly pay back their loans.  Once we have the univariate plots, we can have an idea about what variables we may want to explore in a multi-variate fashion.
...
# Reference 10: https://www.rdocumentation.org/packages/utils/versions/3.4.3/
# topics/str
...
Reference 3: https://docs.google.com/spreadsheets/d/1gDyi_L4UvIrLTEC6Wri5nbaMmkG
mLQBk-Yx3z0XDEtI/edit#gid=0