...
From the faceted scatter plots shown (note that each color in the legend represents 10 data points), it appears that there are far less borrowers with an income greater than $50,000 in the Chargedoff and Defaulted categories than in the Completed and Current categories.  It also looks as if there is around an equal number of borrowers both below and above $50,000 for the Defaulted and Chargedoff categories whereas for the Completed and Current categories, there are more borrowers with over $50,000 dollars in income.  There are far more borrowers with a lower range of credit score above 800 for the Current and Completed loan status than for the Defaulted and Chargedoff loan status.  For the Chargedoff and Defaulted categories, there seems to be more borrowers with a lower range of credit score below 700 than above 700.  Debt to income ratio doesn't appear to play much of a part in determining loan status.  In each of the loan status categories, there appears to be more borrowers below a ratio of 0.5 than above.  In summary, it does appear that having a low credit score and income range makes it more likely that a borrower will end up Defaulting or being charged off with a loan (the probabilities for both, regardless of income/credit score may still be less than 50% as there are more borrowers in general who fall into the Current and Completed status).  It doesn't appear however that debt to income ratio plays a large part in determining loan status.  This is supported by what I found in the univariate case as I thought credit score range lower had a much stronger relationship to loan status than debt to income ratio.  
