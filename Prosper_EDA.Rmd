...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 11, loan_status_is_homeowner_graph}
# Plotting a bar graph of loan_status; proportions for each category filled
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 11, loan_status_prosper_score_graph}
# Plotting a bar graph of loan_status; proportions for each category filled
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 11, loan_status_prosper_rating_graph}
# Plotting a bar graph of loan_status; proportions for each category filled
...
The results from the bar chart and summary go mostly as expected.  The highest proportion of loans assigned a rating of AA are for the Completed loan status.  The lowest proportion assigned this rating is for the Chargedoff status (the proportions go in order from best result to worst, Completed, Current, Defaulted, Chargedoff).  The highest proportion of borrowers assigned the HR rating (the riskiest investments) fall in the Chargedoff loan status.  The lowest and second lowest proportion of borrowers assigned the HR status are for Current and Completed loans, respectively.  Considering ratings AA-B together, the highest and second highest proportions are for Current and Completed status. They are both higher than that of Defaulted and Chargedoff.  Considering ratings HR-D together, Defaulted and Chargedoff both have higher proportions of loans assigned this rating than that of Completed and Current.  The relationship seems strong because 68 and 70 percent of loans fall into these ratings for Defaulted and Chargedoff versus 46 and 29 percent for Completed and Current, respectively. All these results are as expected since the riskiest loans (HR) should result in more Defaulted/Chargedoff statuses while the safest loans (AA) should result in more Completed/Current statuses. 
