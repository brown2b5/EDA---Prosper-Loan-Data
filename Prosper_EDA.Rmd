...
```{r echo=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8, Bivariate_Plots_GGally_non_categorical_loan_status}
...
From the matrix given, there does not appear to be any strong linear  
correlations between the variables.  There are no monotonic relationships 
...
there appears to be an expected relationshiop between loan status and 
