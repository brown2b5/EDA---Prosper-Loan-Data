...
From the bar chart and summaries given, prosper scores of 7-11 make up the greatest proportion for loan statuses of Completed relative to Current, Defaulted and Chargedoff loans.  They also have greater proportions for Current than for Defaulted or Chargedoff loans.  This is not surprising as the highest prosper scores carry the lowest risk and should have the greatest success rate for paying back the loans.  Loans of Completed had the lowest proportion of borrowers from the 1-4 categories while loans of Chargedoff had the highest proportion of 1-4 categories among these four groups.  All this is to be expected (loan status of Current did have a larger proportion of 1-4 categories than Defaulted).  
