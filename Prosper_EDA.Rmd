...
to disappear from the data.  In terms of lower range of credit score predicting
the ability of a borrower to pay back their loans, there is a fairly steep
drop off from around 640 to 625 in the number of borrowers.  I would
be interested to see what percentage of the borrowers to the left of the 
...
# Plot the initial distribution of lower ranges of debt to income ratios (Reference 20)
