...
```{r, GGally_categorical_loan_status_prosper}
...
```{r echo=False, fig.height = 8, fig.width = 8, debt_to_income_ratio_vs_credit_score}
...
from the last three graphs that the data is almost parabolic.  For the second
graph, I decided to cut off the data at debt_to_income_ratio of 10 and
