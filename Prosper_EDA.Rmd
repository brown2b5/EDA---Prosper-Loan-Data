...
# to set all durations for those not employed to be 0 (Reference 24)
...
# Plot the initial distribution of employment status duration (Reference 18)
...
# (Reference 25).  I also zoom in on the newly transformed data.  Note that I 
# added 1 so that I could find the log10 of durations which are 0.  I pick a max of 3 so that I can see all the data (Reference 19). I used coord_cartesian so that I wouldn't shave off any data.
...
# a better binwidth (Reference 18). Note again that I've decided not to 
