...
```{r, echo=FALSE, credit_score_range_lower}
...
for those with higher debt to income ratios is probably student loan debt.  
It could very well be that borrowers with low debt to income ratios
