...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8, debt_to_income_ratio_vs_credit_score}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8,credit_score_vs_income_range}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8,employment_duration_vs_loan_status}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8,credit_score_vs_loan_status}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8,debt_to_income_ratio_vs_loan_status}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8,borrower_apr_vs_loan_status}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 8, fig.width = 8, loan_status_employment_status_graph}
# Plotting a bar graph of loan_status; proportions for each category filled
# by the proportion of each bar under each employment status (References 17 and 18). Usin the subsetted dataframe I created earlier, only considering statues of Employed, Full-time, Not employed, Part-time and Self-employed.
...
done, employee status isn't so much a predictor of loan payback success as 
