...
number of days the current loan is delinquent.  The dependent variables are employment status, employment duration, income range, credit score range lower, debt to income ratio, prosper score, prosper rating, borrower APR and is 
borrower a homeowner.  Note that for prosper score and prosper rating I will 
need to subset the data frame to only include loans which actually have a score and rating (those post July 2009). 
